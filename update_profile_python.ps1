#!/usr/bin/env pwsh
# Script para actualizar el perfil de PowerShell para usar el wrapper Python
...
function Invoke-OpenInterpreter {
    ...
    # Ejecutar Open Interpreter a través del wrapper Python
    bash -c "/Volumes/NVMe1TB/GitHub/open-interpreter/oi_python_wrapper.sh $($Arguments -join ' ')"
}
...
Write-Host "Se ha actualizado el perfil de PowerShell para usar el wrapper Python." -ForegroundColor Green
