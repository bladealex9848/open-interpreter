#!/usr/bin/env pwsh
# Script para actualizar el perfil de PowerShell para usar el nuevo wrapper
...
function Invoke-OpenInterpreter {
    ...
    # Ejecutar Open Interpreter a través del wrapper
    bash -c "/Volumes/NVMe1TB/GitHub/open-interpreter/oi_wrapper.sh $($Arguments -join ' ')"
}
...
Write-Host "Se ha actualizado el perfil de PowerShell para usar el nuevo wrapper." -ForegroundColor Green
