#!/usr/bin/env pwsh
# Script para actualizar el perfil de PowerShell para usar el wrapper Python simple
...
function Invoke-OpenInterpreter {
    ...
    # Ejecutar Open Interpreter a través del wrapper Python simple
    bash -c "/Volumes/NVMe1TB/GitHub/open-interpreter/oi_simple_wrapper.sh $($Arguments -join ' ')"
}
...
Write-Host "Se ha actualizado el perfil de PowerShell para usar el wrapper Python simple." -ForegroundColor Green
